                        ...
                        <div class="card-body">
                            ...
                            <form action="../actions/registro_action.php" method="post">
                                <div class="form-floating mb-3">
                                    <input name="nombre_usuario" type="text" class="form-control" placeholder="name@example.com"
                                        required>
                                    <label>Nombre</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="apellido" type="text" class="form-control" placeholder="name@example.com"
                                        required>
